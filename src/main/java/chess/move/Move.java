...
public class Move {
    ...
    public static int encode(int from, int to, int piece, int capture, int isCapture, int isPromotion, int isCastling, int isEnPassant, int promotedPiece){
        return  ((promotedPiece   & 0xF) << 24) |
                ((isEnPassant     & 0x1) << 23) |
                ((isCastling      & 0x1) << 22) |
                ((isPromotion     & 0x1) << 21) |
                ((isCapture       & 0x1) << 20) |
